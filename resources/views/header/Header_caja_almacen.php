	...
	<nav class="navbar navbar-expand-lg navbar-light" style='background-color: #6C3483;'>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					<div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
							...
							<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/header/Controller_iniciocaja/tabla_almacen' method='POST'>
									<button class="dropdown-item" type="submit">Lista Productos</button>
							</form>
							<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/header/Controller_iniciocaja/tabla_clientes_almacen' method='POST'>
									<button class="dropdown-item" type="submit">Lista de Clientes</button>
							</form>
							<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/header/Controller_iniciocaja/tabla_empleado_almacen' method='POST'>
									<button class="dropdown-item" type="submit">Lista Empleados</button>
							</form>
							<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/header/Controller_iniciocaja/tabla_proveedor_almacen' method='POST'>
				...
				<li class="nav-item">
					...
					<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/header/Controller_iniciocaja/modulo_caja_almacen' method='POST'>
		...
		<div class="dropdown">
			...
			<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
				...
				<div>
				<!-- Busqueda -->
					<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/producto/Controller_producto/buscar_producto_caja_almacen' method='POST'>
				...
				<div>
				<!-- Busqueda -->
					<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/empleado/Controller_empleado/buscar_empleado_caja_almacen' method='POST'>
				...
				<div>
				<!-- Busqueda -->
					<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/proveedor/Controller_proveedor/buscar_proveedor_caja_almacen' method='POST'>
				...
				<div>
				<!-- Busqueda -->
					<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/cliente/Controller_cliente/buscar_cliente_caja_almacen' method='POST'>
