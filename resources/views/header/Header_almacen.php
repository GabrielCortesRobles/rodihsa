	...
	<nav class="navbar navbar-expand-lg navbar-light" style='background-color: #ffc107;'>
				...
				<li class="nav-item">
					<div class="dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
							...
							<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/header/Controller_inicioalmacen/tabla' method='POST'>
									<button class="dropdown-item" type="submit">Lista Productos</button>
							</form>
							<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/header/Controller_inicioalmacen/tabla_clientes' method='POST'>
									<button class="dropdown-item" type="submit">Lista de Clientes</button>
							</form>
							<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/header/Controller_inicioalmacen/tabla_empleado' method='POST'>
									<button class="dropdown-item" type="submit">Lista Empleados</button>
							</form>
							<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/header/Controller_inicioalmacen/tabla_proveedor' method='POST'>
		...
		<div class="dropdown">
			...
			<div class="dropdown-menu" aria-labelledby="dropdownMenu2">
				...
				<div>
				<!-- Busqueda -->
					<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/producto/Controller_producto/buscar_producto_almacen' method='POST'>
				...
				<div>
				<!-- Busqueda -->
					<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/empleado/Controller_empleado/buscar_empleado_almacen' method='POST'>
				...
				<div>
				<!-- Busqueda -->
					<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/proveedor/Controller_proveedor/buscar_proveedor_almacen' method='POST'>
				...
				<div>
				<!-- Busqueda -->
					<form class="form-inline my-2 my-lg-0" action='http://192.168.2.129:8080/systelecoms/index.php/cliente/Controller_cliente/buscar_cliente_almacen' method='POST'>
