  ...
  <!-----Tabla de busqueda cliente------->
	...
	foreach ($res as $object){
		...
		echo "<tr>";
			...
			echo "<td>
			<a href='http://192.168.2.129:8080/systelecoms/index.php/cliente/Controller_cliente/modificar_cliente/$id_cliente'>Modificar </a>/";
			echo "<a href='http://192.168.2.129:8080/systelecoms/index.php/cliente/Controller_cliente/eliminar_cliente/$id_cliente'> Eliminar</a></td>";
		echo "</tr>";
	echo "</tbody>";
	}
	?>
