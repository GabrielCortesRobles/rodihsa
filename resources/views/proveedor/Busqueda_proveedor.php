  ...
  <body>
	...
	foreach ($res as $object){
		...
		echo "<tr>";
			...
			echo "<td>
			<a href='http://192.168.2.129:8080/systelecoms/index.php/proveedor/Controller_proveedor/modificar_proveedor/$id_proveedor'>Modificar </a>/";
			echo "<a href='http://192.168.2.129:8080/systelecoms/index.php/proveedor/Controller_proveedor/eliminar_proveedor/$id_proveedor'> Eliminar</a></td>";
		echo "</tr>";
	echo "</tbody>";
	}
	?>
