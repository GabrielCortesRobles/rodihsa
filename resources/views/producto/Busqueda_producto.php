  ...
  <body>
	...
	foreach ($res as $object){
		...
		echo "<tr>";
			...
			echo "<td>
			<a href='http://192.168.2.129:8080/systelecoms/index.php/producto/Controller_producto/modificar_producto/$id_producto'>Modificar </a>/";
			echo "<a href='http://192.168.2.129:8080/systelecoms/index.php/producto/Controller_producto/eliminar_producto/$id_producto'> Eliminar</a></td>";
		echo "</tr>";
	echo "</tbody>";
	}
	?>
